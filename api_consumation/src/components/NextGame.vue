<template>
  <div v-if="nextGame.id" class="w-100 next-game position-relative">
        ...
        <div class="z-1 position-absolute top-0 left-0 w-100 h-100">
          <div class="row h-100">
            <div class="col-4 m-auto d-flex">
              <img v-if="nextGame.home_team" :src="nextGame.home_team.image_url" class="col-9 m-auto" alt="">
            </div>
            ...
            <div class="col-4 m-auto d-flex">
              <img v-if="nextGame.away_team" :src="nextGame.away_team.image_url" class="col-9 m-auto" alt="">
            </div>
          </div>
        </div>
